...
class TestRegimeDetector:
    ...
    def test_different_random_seeds_converge(self, synthetic_returns_mixed):
        ...
        regime1_high = result1_pd.loc[high_return_mask, "regime"].mode()[0] if high_return_mask.any() else 0
        regime2_high = result2_pd.loc[high_return_mask, "regime"].mode()[0] if high_return_mask.any() else 0
