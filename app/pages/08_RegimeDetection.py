...
if "returns_wide" not in st.session_state or st.session_state["returns_wide"] is None:
    st.warning("Carga datos en la página 01_Data antes de detectar regímenes.")
    st.stop()
...
# =============================================================================
with st.sidebar:
    st.header("Regime Detection Settings")
